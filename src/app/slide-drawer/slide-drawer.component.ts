...
export class SlideDrawerComponent implements AfterViewInit {
  ...
  @Input() handleHeight: number = 500;
  constructor(private gestureCtrl: GestureController, private element: ElementRef, private renderer: Renderer2) { }
  ...
  //     },
  //     onEnd: ev => {
  //       this.renderer.setStyle(this.element.nativeElement, "transitions", "0.3s ease-out")
  //       if (ev.deltaY < -200) {
  //         //snap to top 
